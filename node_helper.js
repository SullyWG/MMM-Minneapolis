...
module.exports = NodeHelper.create({
	...
	getData: function(payload) {
		...
		if (payload.urlBus !== null && payload.stpid !== null && payload.maxRes !== null) {
			var myUrlBus = payload.urlBus + payload.stpid +  "?format=json";
			busReady = true;
		} else if (payload.urlBus !== null && payload.stpid !== null) {
			var myUrlBus = payload.urlBus + payload.stpid +  "?format=json";
			busReady = true;
		} else { console.log("MMM-CTA: Bus config incomplete!!!"); };
		
		if (payload.urlTrain !== null && payload.maxResTrain !== null && payload.idTrain !== null) {
			var myUrlTrain = payload.urlTrain + "&max="+ payload.maxResTrain + "&mapid=" + payload.idTrain + "&outputType=json";
			trainReady = true;
		} else if (payload.urlTrain !== null && payload.idTrain !== null) { // Max result will be 4 by default
			var myUrlTrain = payload.urlTrain + "&max=5" + "&mapid=" + payload.idTrain + "&outputType=json";
			trainReady = true;
